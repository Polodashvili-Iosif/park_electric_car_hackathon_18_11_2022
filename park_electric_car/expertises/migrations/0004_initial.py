...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('expertises', '0003_delete_electriccar_remove_user_car_info_id_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_info_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
